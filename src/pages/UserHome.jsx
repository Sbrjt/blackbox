			...
			<div style={{ padding: '40px', alignItems: 'center' }} className="container">
				<p style={{ marginBottom: '0px', textAlign: 'left', fontSize: '23px', width: '100%', fontFamily: 'Nunito, sans-serif', fontWeight: '700' }}>
					<i>Our Web-Application is your all-in-one solution for managing health records,<br />medications, and schedules.
						It ensures that medical information is always organized,<br /> accessible, and secure.<br /><br /> Whether you're
						tracking personal health or managing patient care,<br /> our platform simplifies the process, helping you stay informed and on
