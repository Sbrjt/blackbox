              ...
              <h3 className="pInfo">
                ...
                <span className="info">
                  {editMode ? (
                    ...
                    <p className="overflow-hidden">{data.age}</p>
                  )}
                </span>
              </h3>
              <br />
              <h3 className="pInfo">
                ...
                <span className="info">
                  {editMode ? (
                    ...
                    <p className="overflow-hidden">{data.father}</p>
                  )}
                </span>
              </h3>
              <br />
              <h3 className="pInfo">
                ...
                <span className="info">
                  {editMode ? (
                    ...
                    <p className="overflow-hidden">{data.mother}</p>
                  )}
                </span>
              </h3>
              <br />
              ...
              <h3 className="pInfo">
                ...
                <span className="info">
                  {editMode ? (
                    ...
                    <p className="overflow-hidden">{data.phone}</p>
                  )}
                </span>
              </h3>
              <br />
              ...
              <h3 className="pInfo">
                ...
                <span className="info">
                  {editMode ? (
                    ...
                    <p className="overflow-hidden">{data.address}</p>
                  )}
                </span>
              </h3>
              <br />
              ...
              <h3 className="pInfo">
                ...
                <span className="info">
                  {editMode ? (
                    ...
                    <p className="overflow-hidden">{data.dob}</p>
                  )}
                </span>
              </h3>
              <br />
              <h3 className="pInfo">
                ...
                <span className="info">
                  {editMode ? (
                    ...
                    <p className="overflow-hidden">{data.gender}</p>
                  )}
                </span>
              </h3>
              <br />
